  ...
  const contactInfo = [
    {
      ...
      text: "Polo Cientifico, Ruta 81, km 2134",
    },
    {
    ...
    },
    {
      ...
      text: "support@RutaBus.com",
    },
  ];
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/rutabus",
    ...
    {
      name: "Email",
      href: "mailto:support@RutaBus.com",
      icon: "M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z",
    },
  ];

  return (
    <footer className="bg-[#63997a] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <nav className="flex flex-wrap gap-6">
              {links.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="text-xl font-bold hover:text-[#fa7f4b] transition-colors duration-300 relative group"
                >
                  {link.name}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#fa7f4b] transition-all duration-300 group-hover:w-full"></span>
                </a>
              ))}
            </nav>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-extrabold">Contáctanos</h3>
            {contactInfo.map((item, index) => (
              <div key={index} className="flex items-center space-x-4 group">
                <div className="bg-[#fa7f4b] p-3 rounded-full transition-transform duration-300 group-hover:scale-110">
                  <svg
        ...
        <div className="mt-16 pt-8 border-t border-white/20 flex justify-between items-center">
          <p className="text-sm">
            &copy; 2024 RutaBus. Todos los derechos reservados.
          </p>
          <div className="flex space-x-6">
            {socialLinks.map((social) => (
              <a
                ...
                className="text-white hover:text-[#fa7f4b] transition-colors duration-300"
